...
let s:predefined_quotes = [
      \ ["ORA ORA ORA ORA ORA ORA ORA ORA ORA ORA ORA ORA ORA", 'ORA ORA ORA ORA ORA ORA ORA ORA ', '- Jotaro Kujo'],
      ...
      \ ['Perhaps… Perhaps the time he foretold has come. If this is my destiny, I accept it.', '', '- Will'],
      \ ['DIO!'],
